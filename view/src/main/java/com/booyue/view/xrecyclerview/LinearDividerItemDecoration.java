...
public class LinearDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public LinearDividerItemDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public LinearDividerItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
