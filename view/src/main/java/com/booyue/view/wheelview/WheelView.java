...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xbd000000;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0x5e000000;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x000000,
			0x000000, 0x000000 };

	/** Additional items height (is added to standard text item height) */
//	private static final int ADDITIONAL_ITEM_HEIGHT = 55;
	private static  int ADDITIONAL_ITEM_HEIGHT = 55;

	/** Text size */
	public int TEXT_SIZE;

	/** Top and bottom items offset (to hide that) */
	private final int ITEM_OFFSET = TEXT_SIZE / 7;
	...
	private void initData(Context context, AttributeSet attrs) {
		...
		int height = (int) context.getResources().getDimension(R.dimen.wheelview_item_offset);

		ADDITIONAL_ITEM_HEIGHT = (int) typedArray.getDimension(R.styleable.WheelView_item_height,height);
		centerDrawable = typedArray.getDrawable(R.styleable.WheelView_center_color);
		backgroundDrawable = typedArray.getDrawable(R.styleable.WheelView_backgroud_color);
		typedArray.recycle();
