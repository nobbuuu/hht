...
import com.bigkoo.pickerview.lib.BooyueWheelView;
 ...
 * @description :
 */
public class BooyueWheelTime {
    public static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private View view;
    private BooyueWheelView wv_year;
    private BooyueWheelView wv_month;
    private BooyueWheelView wv_day;
    private BooyueWheelView wv_hours;
    private BooyueWheelView wv_mins;
    private BooyueWheelView wv_seconds;
    private int gravity;
    ...
    public BooyueWheelTime(View view) {
        super();
        this.view = view;
    ...
    public BooyueWheelTime(View view, TimePickerView.Type type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
        ...
        wv_year.setItemVisibleCount(visibleItemCount);
        ...
        wv_month.setItemVisibleCount(visibleItemCount);
        ...
        wv_day.setItemVisibleCount(visibleItemCount);
        ...
        wv_hours.setItemVisibleCount(visibleItemCount);
        ...
        wv_mins.setItemVisibleCount(visibleItemCount);
        ...
        wv_seconds.setItemVisibleCount(visibleItemCount);
    ...
    private int visibleItemCount = 9;
