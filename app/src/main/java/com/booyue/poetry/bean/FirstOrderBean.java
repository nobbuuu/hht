...
public class FirstOrderBean {
    ...
    public DataDTOD getData() {
        return data;
    }

    public void setData(DataDTOD data) {
        this.data = data;
    }
    ...
    public static class DataDTOD {
        ...
        public static class ListDTO {
            private List<DataDTOD.ListDTO.DataDTO> data;
            private String title;

            public List<DataDTOD.ListDTO.DataDTO> getData() {
                return data;
            }

            public void setData(List<DataDTOD.ListDTO.DataDTO> data) {
                this.data = data;
            }
