...
public class DownloadNewButton extends FrameLayout {
...
//    TextView tvCancel;
    ...
    public DownloadNewButton(@NonNull Context context) {
        this(context, null);
    }

    public DownloadNewButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DownloadNewButton(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    @TargetApi(value = Build.VERSION_CODES.LOLLIPOP)
    public DownloadNewButton(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void initView(Context context) {
        ...
        layoutInflater.inflate(R.layout.layout_download_new_button, this);
...
//            ivDownloadControl.setImageResource(R.drawable.btn_download_refresh);
            rootView.setBackgroundResource(R.drawable.shape_download_button_new_bg);
