...
class StatusBarUtil {
    companion object {
        ...
        @JvmOverloads
        fun immersive(activity: Activity, color: Int = DEFAULT_COLOR, @androidx.annotation.FloatRange(from = 0.0, to = 1.0) alpha: Float = DEFAULT_ALPHA) {
        ...
        @JvmOverloads
        fun immersive(window: Window, color: Int, @androidx.annotation.FloatRange(from = 0.0, to = 1.0) alpha: Float = 1f) {
...
//        }
        ...
        fun darkMode(activity: Activity, color: Int, @androidx.annotation.FloatRange(from = 0.0, to = 1.0) alpha: Float) {
            darkMode(activity.window, color, alpha)
        }

        /** 设置状态栏darkMode,字体颜色及icon变黑(目前支持MIUI6以上,Flyme4以上,Android M以上)  */
        @TargetApi(Build.VERSION_CODES.M)
        fun darkMode(window: Window, color: Int, @androidx.annotation.FloatRange(from = 0.0, to = 1.0) alpha: Float) {
            when {
                isFlyme4Later -> {
         ...
         * 创建假的透明栏
         */
        fun setTranslucentView(container: ViewGroup, color: Int, @androidx.annotation.FloatRange(from = 0.0, to = 1.0) alpha: Float) {
        ...
        fun mixtureColor(color: Int, @androidx.annotation.FloatRange(from = 0.0, to = 1.0) alpha: Float): Int {
